...
console.log(car33(inventory, 33));
...
console.log('Last car added is: ' + lastCar(inventory));

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
const carModelsSorted = (carInventory) => {
  let carModels = [];
...
console.log(carModelsSorted(inventory));
...
const carSearch = (carInventory, carMake1, carMake2) => {
  for (let i = 0; i < carInventory.length; i++) {
    if (carInventory[i].car_make === carMake1) {
      BMWAndAudi.push(carInventory[i]);
    }
    else if (carInventory[i].car_make === carMake2) {
      BMWAndAudi.push(carInventory[i]);
    }
  }
